...
// WiFi and Sinric credentials — replace with your own values
// See config/secrets.example.h and README.md for setup instructions
const char* WIFI_SSID   = "YOUR_WIFI_SSID";
const char* WIFI_PASS   = "YOUR_WIFI_PASSWORD";
const char* APP_KEY     = "YOUR_SINRIC_APP_KEY";
const char* APP_SECRET  = "YOUR_SINRIC_APP_SECRET";
const char* SWITCH_ID   = "YOUR_SWITCH_DEVICE_ID";   // LED
const char* LOCK_ID     = "YOUR_LOCK_DEVICE_ID";     // Door Lock
const char* FAN_ID      = "YOUR_FAN_DEVICE_ID";      // Main Fan
